  ...
  return (
    <header className="p-4">
      ...
      <a href="/">
        ...
        <nav className={`${isOpen ? '' : 'scale-y-0 opacity-0'} absolute left-0 right-0 p-4 top-0 transform transition-all duration-500 ease-out md:relative md:scale-y-100 md:opacity-100 md:p-0 md:transform-none`}>
